...
class App(customtkinter.CTk):
    ...
    def load_html_content_from_file(self, filename):
    ...
    def __init__(self):
        ...
        card_frame.grid(row=0, column=1, rowspan=4, padx=20, pady=20, sticky="nsew")
        ...
        # <html>
        # <body>
        #     <h1>Hello, Register to Sign Up</h1>
        ...
        html_content = self.load_html_content_from_file("templates/1.html")
        
        html_label = HTMLLabel(card_frame, html=html_content, width=800, height=500,
                               )
        html_label.grid(row=0,rowspan=4, column=0, padx=20, pady=20)
        html_frame = tk.Frame(card_frame)
        html_frame.grid(row=0, rowspan=4, column=0, padx=20, pady=20)

        # Create an HTMLLabel with scrollbar
        html_label = HTMLLabel(
            html_frame,
            html=html_content,
            width=800,
            height=500,
            # Set the base_url to the directory containing your CSS and image files
        )
        html_label.grid(row=0, column=0, sticky="nsew")
        import tkinter as tk
        # Create a vertical scrollbar
        scrollbar = tk.Scrollbar(html_frame, orient="vertical", command=html_label.yview)
