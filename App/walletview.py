...
#         combobox.grid(row=3, column=1, columnspan=2, padx=(20, 0), pady=(20, 20), sticky="nsew")
        ...
        # self.checkbox_slider_frame.configure()
        self.checkbox_1 = customtkinter.CTkLabel(self,text='Wallet Id')
        self.checkbox_1.grid(row=1, column=1, pady=(20, 0), padx=20, sticky="n")
        self.checkbox_2 = customtkinter.CTkLabel(self,width=200,text='0')
        self.checkbox_2.grid(row=2, column=1, pady=(20, 0), padx=20, sticky="n")
        
        self.companies_email_label = customtkinter.CTkLabel(self,text='Available Fund')
        self.companies_email_label.grid(row=3, column=1, pady=(20, 0), padx=20, sticky="n")
        self.companies_email = customtkinter.CTkLabel(self,width=200,text='None')
        self.companies_email.grid(row=4, column=1, pady=(20, 0), padx=20, sticky="n")

        self.companies_site_label = customtkinter.CTkLabel(self,text='Available Unit')
        self.companies_site_label.grid(row=5, column=1, pady=(20, 0), padx=20, sticky="n")
        self.companies_site = customtkinter.CTkLabel(self,width=200,text='None')
        self.companies_site.grid(row=6, column=1, pady=(20, 0), padx=20, sticky="n")
