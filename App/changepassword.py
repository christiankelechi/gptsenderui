...
user_pass1 = ctk.CTkEntry(master=frame, placeholder_text="Old Password",show="*", width=350)
user_pass1.pack(pady=12, padx=10)

user_pass = ctk.CTkEntry(master=frame, placeholder_text="New Password", show="*", width=350)
